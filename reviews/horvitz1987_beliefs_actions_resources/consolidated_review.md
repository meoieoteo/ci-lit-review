# Consolidated Review: horvitz1987_beliefs_actions_resources

## Consolidation Status
consolidated_complete

## One-Sentence Takeaway
horvitz1987_beliefs_actions_resources contributes sequential diagnosis, feature-acquisition, or decision-theoretic background to the review, but its direct relevance to pre-cardiology cognitive-risk scoring depends on target, label, timing, and validation fit.
...
Target/outcome: Selection of reasoning strategies that balance expected value of computation against delay or resource cost.
