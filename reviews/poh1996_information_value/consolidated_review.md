# Consolidated Review: poh1996_information_value

## Consolidation Status
consolidated_complete

## One-Sentence Takeaway
poh1996_information_value contributes sequential diagnosis, feature-acquisition, or decision-theoretic background to the review, but its direct relevance to pre-cardiology cognitive-risk scoring depends on target, label, timing, and validation fit.
...
## Key Contributions
Graph-theoretic structure can sometimes determine qualitative EVPI orderings, supporting nonnumeric procedures for prioritizing information gathering.
...
Target/outcome: Qualitative ordering of uncertain variables by informational relevance.
...
The new specialist reviews confirm no direct NLP extraction or EHR schema contribution. Its remaining value is future value-of-information framing after clinical actions and information costs are defined.
