...
## Modeling Relevance
The paper suggests that model complexity is not the main limiting factor. Internal-validation AUROC did not differ substantially across statistical, machine-learning, and deep-learning methods. For our purposes, this argues against treating LLMs, transformers, or other AI methods as the contribution by themselves. The defensible contribution is more likely to come from better problem definition, better label construction, appropriate use of notes, and validation.
