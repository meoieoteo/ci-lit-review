# Primary Review: janisch2020_costly_features
...
Population: Not a clinical population.
...
Inputs or predictors: Partially acquired feature vectors with feature costs.
...
Author-stated limitations: The authors note that theoretical guarantees are lost when using neural function approximation.

Missing or ambiguous information: The paper is not medical, but its motivating examples include diagnosis with costly tests.
