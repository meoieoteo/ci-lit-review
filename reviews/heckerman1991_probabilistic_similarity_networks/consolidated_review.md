# Consolidated Review: heckerman1991_probabilistic_similarity_networks

## Consolidation Status
consolidated_complete

## One-Sentence Takeaway
heckerman1991_probabilistic_similarity_networks contributes sequential diagnosis, feature-acquisition, or decision-theoretic background to the review, but its direct relevance to pre-cardiology cognitive-risk scoring depends on target, label, timing, and validation fit.
...
Target/outcome: Diagnostic inference among competing hypotheses.
